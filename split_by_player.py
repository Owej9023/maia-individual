...
@backend.logged_main
def main():
    parser = argparse.ArgumentParser(description='Split games into games where the target was White or Black', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
