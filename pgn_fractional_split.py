...
@backend.logged_main
def main():
    parser = argparse.ArgumentParser(description='Split games into some number of subsets, by percentage', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
